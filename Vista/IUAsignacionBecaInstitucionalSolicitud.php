<?php
      ...
      $becaInsitucional= new LNBusquedaBecaInstitucional();
    ...
    //if(isset($_SESSION['contrasenia'])){
      ...
      $listaEstudiante=$estudiante->logicaListaEstudiante();
      $listaBecaInstitucional=$becaInsitucional->LogicaListaBecaInstitucional();
?>
<html>
    <head>
