<?php
    require ("../Logica/LNBusquedaDia.php");
    $dia= new LNBusquedaDia();
    require ("../Logica/LNBusquedaHorarioTrabajo.php");
    $horarioTrabajo= new LNBusquedaHorarioTrabajo();
    require ("../Logica/LNBusquedaBecaInstitucional.php");
    $becaIinstitucional= new LNBusquedaBecaInstitucional();
    ...
    $listaDia=$dia->logicaListaDia();
    $listaHorarioTrabajo=$horarioTrabajo->logicaListaHorarioTrabajo();
    //$listaBecaInstitucional=$becaIinstitucional->LogicaListaBecaInstitucional($idPersonal );
    $listaBecaInstitucionalM= $becaIinstitucional->LogicaListaBecaInstitucionalMax();
  ...
  <div class="container">
   ...
   <form method="post"action="../Logica/LNRegistrarHorario.php" >
    <div class="table-repsonsive">
     <span id="error"></span>
     <input type="hidden" name="idSolicitudBecaInstitucional" value="<?php echo $listaHorarioTrabajo['idSolicitudBecaInstitucional']?>"><br>
...
$(document).ready(function(){
 ...
 $('#registrar').on('click',function(){
                var idBecaInstitucional = $('#idBecaInstitucional').val();
                var dia = $('#idDia').val();
