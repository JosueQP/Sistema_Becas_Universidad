<?php
	require_once("../Modelo/BDEstudiantePersistencia.php");
    require_once("../Modelo/BusquedaEstudiante.php");
    $objetoDBEstudiante = new busquedaEstudiante();
    $objetoEstudiantePersistencia = new estudiantePersistencia();

    
    $existeCi=$objetoDBEstudiante->verificarCi($_REQUEST['ci']);
    $arroba="@";
    ...
    if ($existeCi){
        echo "el ci del usuario ya existe";
    }else{
